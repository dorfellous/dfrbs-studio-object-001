...
- The bare root URL is the cinematic opening page. It reuses the optimized user-supplied portrait campaign film as a muted autoplay loop, reveals the DFRBS wordmark first, then reveals 000 / 001 / 002 as the three primary destinations. Product 001 is shareable at `?object=001`.
